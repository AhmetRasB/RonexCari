            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Tahsilat Düzenle</h4>
                ...
                <div class="col-lg-8 mx-auto">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('finance.collections.update', $collection) }}" method="POST">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="position-relative">
                                                ...
                                                <input type="hidden" id="customer_id" name="customer_id" value="{{ old('customer_id', $collection->customer_id) }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('collection_type') is-invalid @enderror" id="collection_type" name="collection_type" required>
                                                ...
                                                <option value="nakit" {{ old('collection_type', $collection->collection_type) == 'nakit' ? 'selected' : '' }}>Nakit</option>
                                                <option value="banka" {{ old('collection_type', $collection->collection_type) == 'banka' ? 'selected' : '' }}>Banka</option>
                                                <option value="kredi_karti" {{ old('collection_type', $collection->collection_type) == 'kredi_karti' ? 'selected' : '' }}>Kredi Kartı</option>
                                                <option value="havale" {{ old('collection_type', $collection->collection_type) == 'havale' ? 'selected' : '' }}>Havale</option>
                                                <option value="eft" {{ old('collection_type', $collection->collection_type) == 'eft' ? 'selected' : '' }}>EFT</option>
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="date" class="form-control @error('transaction_date') is-invalid @enderror" 
                                                   ...
                                                   value="{{ old('transaction_date', $collection->transaction_date->format('Y-m-d')) }}" required>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-text" id="currency-symbol">
                                                    @if($collection->currency == 'TRY')
                                                        ₺
                                                    @elseif($collection->currency == 'USD')
                                                        $
                                                    @elseif($collection->currency == 'EUR')
                                                        €
                                                    @else
                                                        ₺
                                                    @endif
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('currency') is-invalid @enderror" id="currency" name="currency" required>
                                                <option value="TRY" {{ old('currency', $collection->currency) == 'TRY' ? 'selected' : '' }}>₺ TRY</option>
                                                <option value="USD" {{ old('currency', $collection->currency) == 'USD' ? 'selected' : '' }}>$ USD</option>
                                                <option value="EUR" {{ old('currency', $collection->currency) == 'EUR' ? 'selected' : '' }}>€ EUR</option>
                                            </select>
                                            @error('currency')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" 
                                              ...
                                              placeholder="Açıklama">{{ old('description', $collection->description) }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="d-flex justify-content-end gap-2">
                                    <a href="{{ route('finance.collections.show', $collection) }}" class="btn btn-light">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    @if($collection->customer)
        customerSearch.value = '{{ $collection->customer->name }} - {{ $collection->customer->email }}';
    @endif
