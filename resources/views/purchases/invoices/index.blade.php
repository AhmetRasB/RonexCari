                ...
                <div class="d-block d-lg-none">
                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-start mb-2">
                                    <div>
                                        <h6 class="mb-1">
                                            <a href="{{ route('purchases.invoices.show', $invoice) }}" class="text-primary-600 text-decoration-none">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <li>
                                                <form action="{{ route('purchases.invoices.mark-paid', $invoice) }}" method="POST" onsubmit="return confirm('Bu alış faturasını ödendi olarak işaretlemek istediğinize emin misiniz?')">
                                                    @csrf
                                                    <button type="submit" class="dropdown-item">Ödeme Yapıldı</button>
                                                </form>
                                            </li>
                                            @endif
                                ...
                                <div class="row g-2 mb-2">
                                    <div class="col-6">
                                        ...
                                        <div class="fw-medium">{{ $invoice->supplier->name ?? 'Tedarikçi Silinmiş' }}</div>
                                    </div>
                                    <div class="col-6">
                    ...
                    @empty
                        <div class="text-center py-4">
                            ...
                            <p class="text-muted">Henüz alış faturası bulunmuyor.</p>
                        </div>
                    @endforelse
                </div>
...
<script>
    ...
    document.getElementById('deleteSelectedBtn').addEventListener('click', function() {
        ...
        if (confirm(ids.length + ' alış faturasını silmek istediğinizden emin misiniz?')) {
            const form = document.createElement('form');
            form.method = 'POST';
            form.action = '{{ route("purchases.invoices.bulk-delete") }}';
