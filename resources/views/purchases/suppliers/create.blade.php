...
@section('subTitle', 'Tedarikçi Ekle')
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">Yeni Tedarikçi Ekle</h5>
            </div>
            <div class="card-body">
                        ...
                        <div class="col-12">
                            ...
                            <div class="icon-field">
                                ...
                                <input type="text" name="company_name" class="form-control @error('company_name') is-invalid @enderror" 
                                       placeholder="Şirket adı girin" value="{{ old('company_name') }}">
                            </div>
                            @error('company_name')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-12">
                            ...
                            <div class="icon-field">
                                ...
                                <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" 
                                       placeholder="E-posta adresi girin" value="{{ old('email') }}">
                            </div>
                            @error('email')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-12">
                            ...
                            <div class="icon-field">
                                ...
                                <input type="text" name="phone" class="form-control @error('phone') is-invalid @enderror" 
                                       placeholder="Telefon numarası girin" value="{{ old('phone') }}" required>
                            </div>
                            @error('phone')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-12">
                            ...
                            <div class="icon-field">
                                ...
                                <input type="text" name="tax_number" class="form-control @error('tax_number') is-invalid @enderror" 
                                       placeholder="Vergi numarası girin" value="{{ old('tax_number') }}">
                            </div>
                            @error('tax_number')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-12">
                            ...
                            <div class="icon-field">
                                ...
                                <input type="text" name="contact_person" class="form-control @error('contact_person') is-invalid @enderror" 
                                       placeholder="İletişim kişisi girin" value="{{ old('contact_person') }}">
                            </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="icon-field">
                                ...
                                <textarea name="address" class="form-control @error('address') is-invalid @enderror" 
                                          rows="3" placeholder="Adres girin">{{ old('address') }}</textarea>
                            </div>
                            @error('address')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-12">
                            ...
                            <div class="icon-field">
                                ...
                                <textarea name="notes" class="form-control @error('notes') is-invalid @enderror" 
                                          rows="3" placeholder="Notlar girin">{{ old('notes') }}</textarea>
                            </div>
                            @error('notes')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
