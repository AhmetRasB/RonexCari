                            ...
                            <div class="shadow-4 border radius-8">
                                <div class="p-20 d-flex flex-wrap justify-content-between gap-3 border-bottom">
                                    ...
                                    <div>
                                        ...
                                        <h5 class="text-lg fw-semibold mb-2">{{ config('company.name') }}</h5>
                                        <p class="mb-1 text-sm">{{ config('company.address.street') }}</p>
                                        <p class="mb-1 text-sm">{{ config('company.address.street2') }}</p>
                                        <p class="mb-1 text-sm">{{ config('company.address.district') }}, {{ config('company.address.postal_code') }} {{ config('company.address.city') }}/{{ config('company.address.province') }}</p>
                                        <p class="mb-0 text-sm">{{ config('company.contact.phone') }}, {{ config('company.contact.email') }}</p>
                                    </div>
                                </div>
