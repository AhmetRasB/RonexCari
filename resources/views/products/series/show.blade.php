    ...
    <div class="col-12">
        ...
        @endif
                            ...
                            <div class="col-12">
                                ...
                                @php
                                    // Controller computes these to avoid DB queries inside Blade
                                    $groupSeries = $groupSeries ?? collect();
                                    $hasGroup = $hasGroup ?? ($groupSeries->count() > 1);
                                    $groupTotalStock = $groupTotalStock ?? 0;
                                @endphp
                                @if($hasGroup)
