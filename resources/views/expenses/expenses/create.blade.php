...
@if(session('success'))
<!-- Success Modal -->
<div class="modal fade" id="expenseSuccessModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header border-0">
                <h5 class="modal-title"><iconify-icon icon="solar:check-circle-outline" class="text-success me-2"></iconify-icon>Başarılı</h5>
