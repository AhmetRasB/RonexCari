...
@section('subTitle', 'Fatura Yazdırma Önizleme')
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex flex-wrap align-items-center justify-content-end gap-2">
                    <a href="{{ route('sales.invoices.show', $invoice) }}" class="btn btn-sm btn-secondary radius-8 d-inline-flex align-items-center gap-1">
                    ...
                    <a href="{{ route('sales.invoices.print', $invoice) }}" target="_blank" class="btn btn-sm btn-danger radius-8 d-inline-flex align-items-center gap-1">
                                    ...
                                    <div>
                                        ...
                                        <table class="text-sm text-secondary-light">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>Şirket</td>
                                                    <td class="ps-8">: {{ $invoice->customer->company_name }}</td>
                                                </tr>
                                                @endif
                                                ...
                                                <tr>
                                                    <td>Telefon</td>
                                                    <td class="ps-8">: {{ $invoice->customer->phone }}</td>
                                                </tr>
                                                @endif
                                                @if($invoice->customer->email)
                                                <tr>
                                                    <td>E-posta</td>
                                                    <td class="ps-8">: {{ $invoice->customer->email }}</td>
                                                </tr>
                                                @endif
                                            </tbody>
                                        </table>
